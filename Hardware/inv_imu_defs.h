...
#define INV_IMU_AUX1_SUPPORTED       0
#define INV_IMU_AUX2_SUPPORTED       0
#elif defined(ICM45631)
#define INV_IMU_WHOAMI               0xE8
#define INV_IMU_HIGH_FSR_SUPPORTED   0
#define INV_IMU_FSYNC_SUPPORTED      1
#define INV_IMU_USE_BASIC_SMD        0
#define INV_IMU_INT2_PIN_SUPPORTED   1
...
#define INV_IMU_AUX2_SUPPORTED       1
#elif defined(ICM45632M)
#define INV_IMU_WHOAMI               0xE6
#define INV_IMU_HIGH_FSR_SUPPORTED   0
#define INV_IMU_FSYNC_SUPPORTED      1
#define INV_IMU_USE_BASIC_SMD        1
#define INV_IMU_INT2_PIN_SUPPORTED   1
#define INV_IMU_I2C_MASTER_SUPPORTED 0
#define INV_IMU_CLKIN_SUPPORTED      0
#define INV_IMU_AUX1_SUPPORTED       1
#define INV_IMU_AUX2_SUPPORTED       0
#elif defined(ICM45686)
...
#define INV_IMU_AUX2_SUPPORTED       0
#else
#error "Please define the IMU variant"
#endif
 ...
 * same position on two differents registers)
 */
...
#endif
} accel_config0_ap_accel_fs_sel_t;
...
typedef enum { SELFCAL_STEP_RESPONSE = 0x0000, SELFCAL_SC2V_ADC = 0x0020 } selfcal_gyro_method_t;
