...
#define OTP_HEATER_RTC_CONFIG                                                   0x26
typedef struct {
	uint8_t otp_done                                                               : 1;
...
typedef struct {
	...
	uint8_t aux1_i23c_timeout_en                                                   : 1;
} intf_config0_t;
...
typedef struct {
	...
	uint8_t int_status_mask_pin_reserved1                                          : 1;
	uint8_t int_status_mask_pin_reserved2                                          : 1;
	uint8_t resv_1                                                                 : 1;
} int_apex_config1_t;
...
typedef struct {
	...
	uint8_t int_status_reserved2                                                   : 1;
	uint8_t resv_1                                                                 : 1;
} int_apex_status1_t;
...
#define ACCEL_DATA_X_AUX1_0                                                     0x44
#define ACCEL_DATA_X_AUX1_1                                                     0x45
#define ACCEL_DATA_Y_AUX1_0                                                     0x46
#define ACCEL_DATA_Y_AUX1_1                                                     0x47
#define ACCEL_DATA_Z_AUX1_0                                                     0x48
#define ACCEL_DATA_Z_AUX1_1                                                     0x49
#define GYRO_DATA_X_AUX1_0                                                      0x4a
#define GYRO_DATA_X_AUX1_1                                                      0x4b
#define GYRO_DATA_Y_AUX1_0                                                      0x4c
#define GYRO_DATA_Y_AUX1_1                                                      0x4d
#define GYRO_DATA_Z_AUX1_0                                                      0x4e
#define GYRO_DATA_Z_AUX1_1                                                      0x4f
#define TEMP_DATA_AUX1_0                                                        0x50
#define TEMP_DATA_AUX1_1                                                        0x51
#define TMST_FSYNC_DATA_AUX1_0                                                  0x52
#define TMST_FSYNC_DATA_AUX1_1                                                  0x53
...
#define ACCEL_DATA_X_AUX2_0                                                     0x5e
#define ACCEL_DATA_X_AUX2_1                                                     0x5f
#define ACCEL_DATA_Y_AUX2_0                                                     0x60
#define ACCEL_DATA_Y_AUX2_1                                                     0x61
#define ACCEL_DATA_Z_AUX2_0                                                     0x62
#define ACCEL_DATA_Z_AUX2_1                                                     0x63
#define GYRO_DATA_X_AUX2_0                                                      0x64
#define GYRO_DATA_X_AUX2_1                                                      0x65
#define GYRO_DATA_Y_AUX2_0                                                      0x66
#define GYRO_DATA_Y_AUX2_1                                                      0x67
#define GYRO_DATA_Z_AUX2_0                                                      0x68
#define GYRO_DATA_Z_AUX2_1                                                      0x69
#define TEMP_DATA_AUX2_0                                                        0x6a
#define TEMP_DATA_AUX2_1                                                        0x6b
#define TMST_FSYNC_DATA_AUX2_0                                                  0x6c
#define TMST_FSYNC_DATA_AUX2_1                                                  0x6d
#define PWR_MGMT_AUX2                                                           0x6e
typedef struct {
	uint8_t accel_aux2_en                                                          : 1;
	uint8_t gyro_aux2_en                                                           : 1;
	uint8_t accel_aux2_status_pm                                                   : 1;
	uint8_t gyro_aux2_status_pm                                                    : 1;
	uint8_t resv_1                                                                 : 4;
} pwr_mgmt_aux2_t;

#define FS_SEL_AUX2                                                             0x6f
typedef struct {
	uint8_t aux2_accel_fs_sel                                                      : 3;
	uint8_t aux2_gyro_fs_sel                                                       : 4;
	uint8_t resv_1                                                                 : 1;
} fs_sel_aux2_t;
...
typedef struct {
	uint8_t i2cm_go                                                                : 1;
	uint8_t i2cm_blk_srst                                                          : 1;
	uint8_t i2cm_fsm_srst                                                          : 1;
	uint8_t i2cm_speed                                                             : 1;
	uint8_t i2cm_scl_sda_err_disable                                               : 1;
	uint8_t i2cm_timeout_disable                                                   : 1;
	uint8_t i2cm_restart_en                                                        : 1;
	uint8_t i2cm_test_en                                                           : 1;
} i2cm_control_t;
...
#define ACCEL_DEBUG                                                             0xa260
typedef struct {
	uint8_t xl_16fs_debug                                                          : 1;
	uint8_t resv_1                                                                 : 7;
} accel_debug_t;
...
#define STC_TICK_PER_FRC_0                                                      0xa264
#define STC_TICK_PER_FRC_1                                                      0xa265
#define STC_TICK_PER_FRC_SUB                                                    0xa266
typedef struct {
	uint8_t tick_per_frc_sub                                                       : 5;
	uint8_t resv_1                                                                 : 3;
} stc_tick_per_frc_sub_t;
...
#define IREG_OTP_CFG                                                            0xa289
typedef struct {
	uint8_t otp_copy_mode                                                          : 2;
	uint8_t resv_1                                                                 : 6;
} ireg_otp_cfg_t;

#define HEAT_CTRL2                                                              0xa28f
typedef struct {
...
typedef struct {
	uint8_t fifo_retention_shared_sram                                             : 2;
	uint8_t resv_1                                                                 : 6;
} fifo_sram_ret_t;

#define EDMP_SGI_0                                                              0xa2fe
#define EDMP_SGI_1                                                              0xa2ff
...
#define IPREG_SYS1_REG_169                                                      0xa4a9
typedef struct {
	uint8_t gyro_dec1_sat_det                                                      : 3;
	uint8_t resv_1                                                                 : 5;
} ipreg_sys1_reg_169_t;
...
#define IPREG_SYS2_REG_128                                                      0xa580
typedef struct {
	uint8_t tmp_lpf_cfg                                                            : 3;
	uint8_t tmp_dec_cfg                                                            : 3;
	uint8_t resv_1                                                                 : 2;
} ipreg_sys2_reg_128_t;
...
typedef struct {
	...
	uint8_t pads_aux2_cs_from_pad_disable_trim_d2a                                 : 1;
	uint8_t pads_aux2_cs_pe_trim_d2a                                               : 1;
} ipreg_bar_reg_59_t;

#define IPREG_BAR_REG_60                                                        0xa03c
typedef struct {
	uint8_t pads_aux2_cs_pud_trim_d2a                                              : 1;
